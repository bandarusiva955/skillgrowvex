    ...
    <div className="academy-site">
      <section className="academy-hero">
        ...
        <div className="academy-container academy-hero-layout">
          ...
          <div className="academy-hero-dashboard hero-float-anim" aria-label="Learning dashboard preview"><div className="academy-hero-photo"><Image src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&auto=format&fit=crop" alt="AI and technology-powered education" fill priority sizes="(max-width: 900px) 90vw, 520px" />{/* TODO: swap with official SkillGrowVex branded image */}</div><div className="academy-dashboard-window"><div className="academy-window-bar"><span /><span /><span /><b>skillgrowvex / learner</b></div><div className="academy-window-body"><div className="academy-mini-sidebar"><strong>SGV</strong><span>⌂</span><span>◈</span><span>✓</span><span>↗</span></div><div className="academy-mini-main"><small>GOOD MORNING, LEARNER</small><h2>Your learning HQ</h2><div className="academy-mini-progress"><div><span>Full Stack Development</span><b>64%</b></div><i /></div><div className="academy-mini-cards"><div><LineChart size={16} /><strong>03</strong><small>Projects</small></div><div><CheckCircle2 size={16} /><strong>12</strong><small>Skills</small></div><div><MessageCircle size={16} /><strong>01</strong><small>Mentor review</small></div></div><div className="academy-mini-task"><span>UP NEXT</span><b>Publish your project README</b><ArrowRight size={16} /></div></div></div></div><p className="academy-dashboard-caption">A clearer path from first lesson to career-ready work.</p></div>
        </div>
      </section>
